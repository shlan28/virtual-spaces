...
function up(event:PointerEvent){
 ...
 else if(data.pending){if(!panelOpen)navigation?.save();panelOpen=true;ui.showInsight('下一场对话，留在云端','目前接入的是锦供参考第六期真实访谈。这里预留给未来访谈，不代表已有节目或嘉宾。',()=>{closePanel();navigation?.navigate('interview');});}
}
